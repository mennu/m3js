    ...
    myGraph.Line = function (conf)
    {
        ...
        */
        ...
        if (typeof conf === 'object' && conf.data) {
            if (typeof conf.data[0] === 'number' || myGraph.isNull(conf.data[0])) {

                this.original_data[0] = myGraph.arrayClone(conf.data);

            //} else if (typeof conf.data[0] === 'object' && !myGraph.isNull(conf.data[0])) {
            } else {

                for (var i=0; i<conf.data.length; ++i) {
                    this.original_data[i] = myGraph.arrayClone(conf.data[i]);
                }
            }
            ...
            for (var i=1; i<arguments.length; ++i) {
                ...
                if (   arguments[1]
                    ...
                    for (var i=0; i<arguments[1].length; ++i) {
                        tmp[i] = myGraph.array_clone(arguments[1][i]);
                    }
    
                    for (var j=0; j<tmp.length; ++j) {
                        this.original_data[j] = myGraph.array_clone(tmp[j]);
                    }
    
                } else {
                    this.original_data[i - 1] = myGraph.array_clone(arguments[i]);
                }
            }
        }
        ...
        */
        this.data_arr = myGraph.array_linearize(this.original_data);
        ...
        this.Set = function (name)
        {
            ...
            */
            if (name == 'chart.linewidth' && navigator.userAgent.match(/Chrome/)) {
                ...
                } else if (myGraph.is_array(value)) {
        ...
        */
        ...
        this.Draw = function ()
        {
            ...
            */
            ...
            //        alert('[myGraph WARNING] Chrome has a shadow bug, meaning you should increase the linewidth to at least 1.01');
            //}
            ...
            if (prop['chart.ymax']) {
                ...
                if (!prop['chart.outofbounds']) {
                    for (dataset=0; dataset<this.data.length; ++dataset) {
                        if (myGraph.isArray(this.data[dataset])) {
                ...
                for (var i=0,len=this.coords2.length; i<len; i+=1) {
                    for (var j=0,len2=this.coords2[i].length; j<len2; ++j) {
                        if (typeof(this.coords2[i][j]) == 'object' && typeof(this.coords2[i][j][0]) == 'number' && typeof(this.coords2[i][j][1]) == 'number') {
                            ...
                            var tickmarks = typeof prop['chart.tickmarks'] == 'object' && !myGraph.is_null(prop['chart.tickmarks']) ? prop['chart.tickmarks'][i] : prop['chart.tickmarks'];
                            co.strokeStyle = prop['chart.colors'][i];
                            this.DrawTick(  this.coords2[i],
                                            this.coords2[i][j][0],
                                            this.coords2[i][j][1],
        ...
        */
        ...
        this.DrawLine = function (lineData, color, fill, linewidth, tickmarks, index)
        {
            ...
            */
            ...
            for (i=0,len=lineData.length; i<len; i+=1) {
                ...
                */
                ...
                // Null data points, and a special case for this bug:http://dev.myGraph.net/tests/ymin.html
                if (   lineData[i] == null
            ...
            */
            //if (false && myGraph.ISCHROME && prop['chart.shadow'] && prop['chart.chromefix'] && prop['chart.shadow.blur'] > 0) {
            //
        ...
        */
        this.parseColors = function ()
        {
            ...
            if (this.original_colors.length === 0) {
                ...
                this.original_colors['chart.fillstyle']             = myGraph.array_clone(prop['chart.fillstyle']);
        ...
        this.trace = function ()
        {
            ...
            */
            var div = doc.createElement('DIV');
                ...
                div.id = '__myGraph_trace_animation_' + RG.random(0, 4351623) + '__';
            ...
            obj.canvas.__myGraph_trace_div__ = div;
    
            /**
            * Make the second canvas
            */
            var id      = '__myGraph_line_trace_animation_' + RG.random(0, 99999999) + '__';
            ...
            obj.canvas.__myGraph_line_canvas2__  = canvas2;
            ...
            */
            ...
            obj.canvas.__myGraph_trace_obj2__ = obj2;
            ...
            */
            if (!obj.canvas.__myGraph_trace_cover__) {
                var div2 = doc.createElement('DIV');
                    div2.id = '__myGraph_trace_animation_' + RG.random(0, 4351623) + '__';
                    ...
                    div.div2 = div2;
                    obj.canvas.__myGraph_trace_cover__ = div2;
                doc.body.appendChild(div2);
            } else {
                div2 = obj.canvas.__myGraph_trace_cover__;
            }
            ...
            */
            ...
            {
                var obj2 = obj.canvas.__myGraph_trace_obj2__;
                ...
                obj.Set('filled', myGraph.array_clone(obj2.Get('chart.filled')));
                obj.Set('fillstyle', obj.Get('chart.animation.trace.original.fillstyle'));
                obj.Set('colors', myGraph.array_clone(obj2.Get('chart.colors')));
                obj.Set('key', myGraph.array_clone(obj2.Get('chart.key')));
    
                myGraph.RedrawCanvas(obj.canvas);
    
                obj.canvas.__myGraph_trace_div__.style.display    = 'none';
                obj.canvas.__myGraph_line_canvas2__.style.display = 'none';
                obj.canvas.__myGraph_trace_cover__.style.display  = 'none';
                obj.canvas.__myGraph_trace_div__    = null;
                obj.canvas.__myGraph_line_canvas2__ = null;
                obj.canvas.__myGraph_trace_cover__  = null;
