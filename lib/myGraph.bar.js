    ...
    */
    myGraph.Bar = function (conf)
    {
        ...
        */
        ...
        this.ismyGraph               = true;
        this.uid                    = myGraph.CreateUID();
        this.canvas.uid             = this.canvas.uid ? this.canvas.uid : myGraph.CreateUID();
        ...
        */
        //myGraph.OldBrowserCompat(this.context);
        ...
        this.properties =
        {
            ...
            'chart.tooltips.css.class':     'myGraph_tooltip',
        ...
        */
        for (var i=0; i<data.length; ++i) {
            if (typeof data[i] === 'object' && !myGraph.is_null(data[i])) {
        ...
        */
        var linear_data = myGraph.array_linearize(data);
        ...
        */
        this.data_arr = myGraph.array_linearize(this.data);
        ...
        * done already
        */
        if (!this.canvas.__myGraph_aa_translated__) {
            this.context.translate(0.5,0.5);

            this.canvas.__myGraph_aa_translated__ = true;
        }
        ...
        this.Drawbars = function ()
        {
            ...
            */
            if (prop['chart.ymax']) {
                ...
                this.scale2 = myGraph.getScale2(this, {
                                                    'max':prop['chart.ymax'],
                                                    'strict': true,
                                                    'min':prop['chart.ymin'],
            ...
            */
            ...
            for (i=0,len=this.data.length; i<len; i+=1) {
                ...
                var height = ((myGraph.array_sum(this.data[i]) < 0 ? myGraph.array_sum(this.data[i]) + this.scale2.min : myGraph.array_sum(this.data[i]) - this.scale2.min) / (this.scale2.max - this.scale2.min) ) * (ca.height - this.gutterTop - this.gutterBottom);
                ...
                */
                co.beginPath();
                    if (typeof(this.data[i]) == 'number') {
                        ...
                        */
                        if (barWidth < 0) {
                            alert('[myGraph] Warning: you have a negative bar width. This may be caused by the chart.hmargin being too high or the width of the canvas not being sufficient.');
                        }
                        ...
                        */
                        ...
                        // Regular bar
                            ...
                            if (myGraph.ISOLD && shadow) {
                                this.DrawIEShadow([x + hmargin, y, barWidth, height]);
                            }
                            
                            if (variant == 'glass') {
                                myGraph.filledCurvyRect(co, x + hmargin, y, barWidth, height, 3, this.data[i] > 0, this.data[i] > 0, this.data[i] < 0, this.data[i] < 0);
                                myGraph.strokedCurvyRect(co, x + hmargin, y, barWidth, height, 3, this.data[i] > 0, this.data[i] > 0, this.data[i] < 0, this.data[i] < 0);
                            } else {
                        ...
                        */
                        ...
                        for (j=0; j<dataset.length; ++j) {
                            ...
                            */
                            ...
                            var totalHeight = (myGraph.array_sum(dataset) / this.scale2.max) * (ca.height - hmargin - this.gutterTop - this.gutterBottom);
            ...
            if (prop['chart.xaxispos'] == 'top') {
                ...
                */
                if (typeof(prop['chart.ylabels.specific']) == 'object' && prop['chart.ylabels.specific']) {
                    ...
                    var labels = myGraph.array_reverse(prop['chart.ylabels.specific']);
                ...
                if (prop['chart.ymin'] != 0 || prop['chart.noxaxis'] || prop['chart.scale.zerostart']) {
                    ...
                    myGraph.Text2(this, {'font': font,
                                        'size': text_size,
                                           'x': xpos,
                                           'y': this.gutterTop,
                                        'text': (this.scale2.min != 0 ? '-' : '') + myGraph.number_format(this,(this.scale2.min.toFixed((prop['chart.scale.decimals']))), units_pre, units_post),
                                      'valign': 'center',
                                      'halign': align,
                                    'bordered': boxed,
                                        'tag': 'scale'});
            ...
            if (prop['chart.xaxispos'] == 'center') {
                ...
                */
                if (this.scale2.min != 0 || prop['chart.scale.zerostart']) {
                    RG.Text2(this, {'font':font,'size':text_size, 'x':xpos, 'y':this.gutterTop + this.halfgrapharea,'text': myGraph.number_format(this,(this.scale2.min.toFixed((prop['chart.scale.decimals']))), units_pre, units_post),'valign':'center', 'valign':'center','halign': align, 'bordered': boxed, 'tag':'scale'});
                }
            }
        };
        ...
        */
        ...
        this.getBar = function (e)
        {
            ...
            var mouseXY = myGraph.getMouseXY(e);
            ...
            for (var i=0,len=coords.length; i<len; i+=1) {
                ...
                if (mouseX >= left && mouseX <= (left + width) && mouseY >= top && mouseY <= (top + height)) {
                    ...
                    if (prop['chart.tooltips']) {
                        var tooltip = myGraph.parseTooltipText ? myGraph.parseTooltipText(prop['chart.tooltips'], i) : prop['chart.tooltips'][i];
                    }
        ...
        */
        ...
        {
            var canvas      = e.target;
            var mouseCoords = myGraph.getMouseXY(e);
        ...
        */
        this.getValue = function (arg)
        {
            ...
            if (arg.length == 2) {
                ...
                var mouseCoords = myGraph.getMouseXY(arg);
                var mouseX      = mouseCoords[0];
                var mouseY      = mouseCoords[1];
            }
        ...
        */
        ...
        this.Highlight = function (shape)
        {
            ...
            myGraph.Highlight.Rect(this, shape);
        };
        ...
        */
        this.positionTooltip = function (obj, x, y, tooltip, idx)
        {
            ...
            var canvasXY   = myGraph.getCanvasXY(obj.canvas);
            ...
            */
            ...
            var img = new Image();
                ...
                img.id = '__myGraph_tooltip_pointer__';
                if (value >= 0) {
        ...
        */
        this.parseColors = function ()
        {
            ...
            if (this.original_colors.length === 0) {
                this.original_colors['chart.colors']                = myGraph.array_clone(prop['chart.colors']);
                this.original_colors['chart.key.colors']            = myGraph.array_clone(prop['chart.key.colors']);
        ...
        this.parseSingleColorForGradient = function (color)
        {
            ...
            if (color.match(/^gradient\((.*)\)$/i)) {
                ...
                for (var j=1,len=parts.length; j<len; ++j) {
                    grad.addColorStop(j * diff, myGraph.trim(parts[j]));
                }
            }
        ...
        */
        this.waveOld = function ()
        {
            ...
            obj.draw();
            //var scale = myGraph.getScale2(obj, {'max':obj.max});
        ...
        */
        this.grow = function ()
        {
            ...
            // Save the data
            obj.original_data = myGraph.array_clone(obj.data);
            ...
            if (obj.Get('chart.ymax') == null) {
                ...
                var scale = myGraph.getScale2(obj, {'max':ymax});
            ...
            var iterator = function ()
            {
                ...
                //myGraph.clear(obj.canvas);
                myGraph.redrawCanvas(obj.canvas);
    ...
    * This is the combined bar and Line class which makes creating bar/line combo charts a little bit easier *
    ...
    myGraph.CombinedChart = function ()
    {
        /**
        ...
        */
        ...
        if (myGraph.is_array(arguments[0])) {
            objects = arguments[0];
        }
        ...
        */
        if (resizable_object) {
            ...
            */
            ...
            myGraph.AddCustomEventListener(resizable_object,
                                          'onresizebeforedraw',
    ...
    */
    myGraph.CombinedChart.prototype.add =
    myGraph.CombinedChart.prototype.Add = function (obj)
    {
    ...
    */
    myGraph.CombinedChart.prototype.draw =
    myGraph.CombinedChart.prototype.Draw = function ()
    {
