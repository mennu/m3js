    ...
    myGraph.Pie = function (conf)
    {
        ...
        */
        ...
        this.DrawSegment = function (radians, color, last, index)
        {
            ...
            if (myGraph.ISOLD && radians == RG.TWOPI) {
                radians -= 0.0001;
            } else if (myGraph.ISOLD && radians == 0) {
                radians = 0.001;
            }
            ...
            for (var o=0; o<size; ++o) {
                ...
                setTimeout(
                    function ()
                    {
                        ...
                        RG.Clear(ca);
                        RG.RedrawCanvas(ca);
                    }, o * (myGraph.ISIE &&  !myGraph.ISIE10 ? 25 : 16.666));
            }
        };
        ...
        */
        this.explode = function ()
        {
            ...
            var iterator = function ()
            {
                ...
                if (frame++ < frames) {
                    myGraph.Effects.updateCanvas(iterator);
                } else {
                    callback(obj);
                }
            }
